 ...
 */
export async function generateManifest(dist, cfg) {
    // select template
    const templateName = cfg.scorm === "1.2" ? "imsmanifest12.xml.hbs" : "imsmanifest2004.xml.hbs";
    const tmplPath = path.join(path.dirname(import.meta.url.replace("file://", "")), "../../templates", templateName);
 ...
 * Auto-detect launch file
 */
function detectLaunchFile(files) {
